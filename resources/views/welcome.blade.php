  ...
  <header id="header" class="fixed-top d-flex justify-content-center align-items-center header-transparent">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        @else
        <a class="nav-link scrollto active" href="{{ url('/login') }}">
          <h2>LOGIN</h2>
        </a>
        @endif
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="section-title">
          ...
          <p>An employee management system provides managers with insights into their workforce,<br>
            and helps them to better plan and manage work hours to easily control labor costs and increase productivity.
          </p>
        </div>
            ...
            <div class="content ps-lg-4 d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <p>
                    With employee management software, you can utilize the standard metrics for employee management. You
                    can also customize or create your own metrics for
                    the needs of the staff management in your company with ease. The pocket HRMS has a very easy to
                    handle user interface and is seamless to help you with the performance management of the employees.
                    The software gives you to have an upper view of the entire staff management. The employee management
                    system, also there to help you with the tools such as an
                    analytically driven metric system. With the timesheet management and time tracking software, it is
                    all in one resource and the right employee management system for meaningful data and smart decision
                ...
                <div class="col-lg-6">
                  ...
                  <p>
                    An employee management system is a software, that helps your employees to give their best efforts
                    every day to achieve the goals of your organization. It guides and manages employees efforts in the
                    right direction.
                    It also securely stores and manages personal and other work-related details for your employees. That
                    makes it easier to store and access the data when there is a need.
                    In the employee management system, you can manage admin activities in an easier and quicker way.
                    Employees are an important part of your organization it is their work that ultimately contributes to
                    the bottom line of the company.
                    It is an important part of HR management. It also helps to employee engagement and employee
                    retention brings down costs and increases productivity.
                  </p>
                </div>
              </div>
              <div class="row mt-n4">
                <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p> The staff can access the basic information on the portal without approaching human resources for
                      it</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p> With a self-service portal, employees are more engaged and feel more empowered in your
                      organization.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p> Company culture is important for the profitability of an organization. We are no longer live in
                      an era where all we can expect from employees</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p> The advantage of employee management software is that it is cloud-based software. Giving you
                      access wherever you are at. You don’t have to hold on to the decisions for lack of information.
                    </p>
                  </div>
                </div>
              </div>
