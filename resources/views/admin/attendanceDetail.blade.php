        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <table class="table table-striped" id="myTable">
                    <div class="table-title">
                        <div class="row">
                          <div class="col-sm-8"><h2><b>Employees Attendance</b></h2></div>
                                <div class="col-sm-3">
            ...
            <nav aria-label="...">
                <ul class="pagination" style="float: right;margin: 0 0 10px;">
                  ...
                  <li class="page-item ">
                    <a class="page-link" href="{{$user_att->previousPageUrl()}}"><<</a>
                  </li>&nbsp;
                  @endif
                  <li class="page-item"><h6 class="page-link" style="color: black" >{{$user_att->currentPage()}}</h6></li>&nbsp;
